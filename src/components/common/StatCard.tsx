...
function StatCard({ stat, accent }: StatCardProps) {
  return (
    <article className="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-[0_8px_24px_rgba(36,50,61,0.05)]">
      ...
      <p className="mt-1 font-['Manrope'] text-3xl font-bold text-[#24323d]">{stat.value}</p>
