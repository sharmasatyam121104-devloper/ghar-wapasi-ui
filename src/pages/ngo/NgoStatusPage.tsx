...
const statusTheme: Record<NgoProfile['status'], { label: string; description: string; className: string }> = {
  ...
  verified: {
    label: 'Verified',
    description: 'Your organisation is verified. The NGO portal is now open for you.',
      ...
      <div className="rounded-2xl border border-slate-200/80 bg-surface p-5 shadow-[0_8px_24px_rgba(15,23,42,0.05)] sm:p-6">
        ...
        {profile.vivaCallLink ? (
          ...
          <p className="mt-4 rounded-xl bg-canvas px-4 py-3 text-sm leading-6 text-slate-500">
            No viva call scheduled yet. The admin will schedule a link and time, and it will appear here.
          </p>
        )}
      </div>
    </div>
